...
alias dor='ssh -X skyshaw@10.110.23.131'
...
alias mnt-work='sudo mount /dev/sda3 ~/Documents/work'
...
alias eclipsecpp='~/Documents/bin/eclipse-cpp/eclipse'
alias eclipsejava='~/Documents/bin/eclipse-java/eclipse'
