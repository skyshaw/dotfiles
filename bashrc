...
export PATH=/var/lib/gems/1.8/bin:/home/skyshaw/Documents/tools/:$PATH
MYPATH=~/Documents/bin
CDPATH=".:$HOME/Documents/code/:$HOME/Documents/src/lua-5.1.4/:$HOME/Documents/docs/:$HOME/Documents/"
